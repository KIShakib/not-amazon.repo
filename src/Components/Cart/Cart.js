    ...
    return (
            <div className='bg-[#95a5a6] ml-4 text-white  added-cart'>
                <div className='mt-10'>
                    ...
                    <div className='pl-4'>
                        <h4>Selected Items: <span className='font-bold text-xl text-secondary'>${quantity}</span></h4>
                    ...
                    <div className='flex flex-col gap-4'>
                        <button className="btn btn-active btn-secondary hover:bg-warning mx-4">
                            Order
                            <span className='ml-2 text-white'><FontAwesomeIcon icon={faArrowCircleRight}></FontAwesomeIcon></span>
                        </button>
                        <button onClick={clearAll} className="btn btn-warning text-white hover:bg-secondary mx-4">
                            Clear
